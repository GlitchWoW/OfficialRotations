...
Talents:
- M+
CoQAAAAAAAAAAAAAAAAAAAAAAAmZmZmZEzmhxsZmZYWGAAAAAAAAAAzAGzYYBGYZ0GNswMMzsNmZzMzMzYYmBzMmxYmZAAA
- ST:
CoQAAAAAAAAAAAAAAAAAAAAAAAMzMzMjYWMMmtZmZYWGAAAAAAAAAAzAGzYYBGYb0CNswMzMGjZ2MzMzMGzMwMzMDzMDAAA
...
Changelog:
30/09/2024 - v1.3.0
- Swapped SF logic to common module and removed the old setting
- Changed some logic up for healthstones

09/11/2024 - v1.2.8 + 1.2.9
- Vilespell now also under the "hold cooldowns" toggle.
- Fixed a ST ramp condition for no GFG builds (Kalamazi builds)

09/10/2024 - v1.2.6 + v1.2.7
- Fixed demonic strenght usage for builds without GFG
- Fixed some ramp logic not properly working

1.2.7:
- A bit more ramp logic for non-GFG builds.

09/08/2024 - v1.2.5
- Fixed talent builds
- Fix for no vilefiend

04/08/2024 - v1.2.3 + v.1.2.4 (Ty @Turkar)
- Proper fix for builds not running GFG
- fixed overcap on implosion

04/08/2024 - v1.2.2
- Fix for Ruination (Hero talent)
- Fix for infernal bolt
