Build: 
- CYQAYp+JUk5Lea12OyacsLNThAAAAAAMLzy2MjZGzilhZGzYGDAAAAA2MzyixMsYyCziZaoZWAAMNzwMbGmpZMzMDsMjZGmtZ2sxYMDzMbMA
PvP talents: 
- Burrow, Grounding Totem, Unleash Shield (Main)
- alternatives: Swap out grounding totem/unleash shield with skyfury/
traveling storms/counterstrike totem as options. I recommend keeping burrow for 
the extra defensive.
...
Spread your flame shocks with mouseover! (There is a toggle if you want to use experimental LOS logic)
