...
q2='''query($code:String!,$fightIDs:[Int],$start:Float,$end:Float){reportData{report(code:$code){events(dataType:Healing,fightIDs:$fightIDs,startTime:$start,endTime:$end,useAbilityIDs:true,includeResources:true){data}}}}'''
res=gql(q2,{'code':code,'fightIDs':[fight],'start':fi['startTime'],'end':fi['startTime']+20000})
