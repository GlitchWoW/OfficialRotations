...
q2='''query($code:String!,$fightIDs:[Int],$start:Float,$end:Float){reportData{report(code:$code){events(dataType:DamageTaken,fightIDs:$fightIDs,startTime:$start,endTime:$end,useAbilityIDs:true){data}}}}'''
